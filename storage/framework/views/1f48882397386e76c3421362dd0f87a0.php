...
<title><?php echo $__env->yieldContent('page-title', 'Admin Dashboard'); ?> — KSPM SV IPB</title>
...
<aside class="sidebar" id="sidebar">
  ...
  <div class="sb-admin-badge">
    ...
    <div>
      <div class="sb-admin-name"><?php echo e(Auth::user()->name ?? 'Admin KSPM'); ?></div>
  ...
  <div class="sb-scroll">
    ...
    <a href="<?php echo e(url('/admin/dashboard')); ?>" class="nav-item <?php echo e(request()->is('admin/dashboard') ? 'active' : ''); ?>">
        <span class="ni-icon">🏠</span> Dashboard
    </a>
    <a href="<?php echo e(url('/admin/analitik')); ?>" class="nav-item <?php echo e(request()->is('admin/analitik') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(url('/admin/anggota')); ?>" class="nav-item <?php echo e(request()->is('admin/anggota*') ? 'active' : ''); ?>">
        <span class="ni-icon">👥</span> Manajemen Anggota
    </a>
    <a href="<?php echo e(url('/admin/kegiatan')); ?>" class="nav-item <?php echo e(request()->is('admin/kegiatan*') ? 'active' : ''); ?>">
        <span class="ni-icon">📅</span> Kegiatan & Event
    </a>
    <a href="<?php echo e(url('/admin/lomba')); ?>" class="nav-item <?php echo e(request()->is('admin/lomba*') ? 'active' : ''); ?>">
        <span class="ni-icon">🏆</span> Info Lomba <span class="ni-badge">3</span>
    </a>
    <a href="<?php echo e(url('/admin/riset')); ?>" class="nav-item <?php echo e(request()->is('admin/riset*') ? 'active' : ''); ?>">
        <span class="ni-icon">📊</span> Riset & Publikasi
    </a>
    <a href="<?php echo e(url('/admin/pengumuman')); ?>" class="nav-item <?php echo e(request()->is('admin/pengumuman*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(url('/admin/home-content')); ?>" class="nav-item <?php echo e(request()->is('admin/home-content*') ? 'active' : ''); ?>">
        <span class="ni-icon">🏠</span> Home Content
    </a>
    <a href="<?php echo e(url('/admin/about-us')); ?>" class="nav-item <?php echo e(request()->is('admin/about-us*') ? 'active' : ''); ?>">
        <span class="ni-icon">🏛️</span> About / Tentang
    </a>
    <a href="<?php echo e(url('/admin/gallery')); ?>" class="nav-item <?php echo e(request()->is('admin/gallery*') ? 'active' : ''); ?>">
        <span class="ni-icon">🖼️</span> Events & Gallery
    </a>
    <a href="<?php echo e(url('/admin/rekrutmen')); ?>" class="nav-item <?php echo e(request()->is('admin/rekrutmen*') ? 'active' : ''); ?>">
        <span class="ni-icon">🎯</span> Open Recruitment
    </a>
    <a href="<?php echo e(url('/admin/contact')); ?>" class="nav-item <?php echo e(request()->is('admin/contact*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(url('/admin/kalkulator')); ?>" class="nav-item <?php echo e(request()->is('admin/kalkulator*') ? 'active' : ''); ?>">
        <span class="ni-icon">🧮</span> Kalkulator Saham
    </a>
    <a href="<?php echo e(url('/admin/kamus')); ?>" class="nav-item <?php echo e(request()->is('admin/kamus*') ? 'active' : ''); ?>">
        <span class="ni-icon">📖</span> Kamus Investasi
    </a>
    <a href="<?php echo e(url('/admin/market')); ?>" class="nav-item <?php echo e(request()->is('admin/market*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(url('/admin/pengaturan')); ?>" class="nav-item <?php echo e(request()->is('admin/pengaturan*') ? 'active' : ''); ?>">
        <span class="ni-icon">⚙️</span> Pengaturan
    </a>
    <a href="<?php echo e(url('/')); ?>" target="_blank" class="nav-item" style="color:rgba(255,255,255,.5)">
...
<div class="main">
  ...
  <div class="topbar">
    <div class="topbar-left flex items-center gap-3">
      ...
      <div>
        <div class="font-bold text-base text-gray-900"><?php echo $__env->yieldContent('page-title'); ?></div>
        <div class="text-xs text-gray-400">KSPM SV IPB / <span><?php echo $__env->yieldContent('page-breadcrumb'); ?></span></div>
      </div>
    </div>
...
</html><?php /**PATH D:\kspm-sisfor\zxcvb\resources\views/layouts/admin.blade.php ENDPATH**/ ?>